...
public class EmailService {
    ...
    private String buildEmail() {
        return "<html><body style='font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f5f5f5;'>"
            +
            "<div style='max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius:"
            +
            ...
            +
            " href='https://java2-menuo-su-it.northeurope.cloudapp.azure.com/login'>Read Newsletter</a>"
            + "</div></body></html>";
    }
